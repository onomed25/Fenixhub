...
<<<<<<< Updated upstream
    ...
    // podendo ser forçado para true via DB_REJECT_UNAUTHORIZED=true quando CA customizada for configurada.
    const rejectUnauthorized = env.DB_REJECT_UNAUTHORIZED === 'true';
